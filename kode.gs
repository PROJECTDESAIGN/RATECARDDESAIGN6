...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & teks utama menggunakan warna Oranye Bata / Terracotta (#C85A32) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #C85A32}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#C85A32;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#C85A32;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#C85A32;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone krem/peach soft (#FDF8F5) */
    '.info-box{background:#FDF8F5;border:1px solid #F3DDD3;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna dasar Oranye Bata (#C85A32) */
    '.paket-box{background:#C85A32;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#FFFCFA;border:1px solid #F6E6DF;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft terracotta (#FAF0EC) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#FAF0EC;border:1px solid #EBC8BA;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#A8431D;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #F3DDD3;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
